...
test('toast manager can be rendered', function () {
    Livewire::test(ToastManager::class)
        ->assertOk()
        ->assertSee('pointer-events-none');
});

test('toast manager can add success toast', function () {
    Livewire::test(ToastManager::class)
...
test('toast manager can add error toast', function () {
    Livewire::test(ToastManager::class)
...
test('toast manager can add warning toast', function () {
    Livewire::test(ToastManager::class)
...
test('toast manager can add info toast', function () {
    Livewire::test(ToastManager::class)
...
test('toast manager can remove toast', function () {
...
test('toast manager can handle multiple toasts', function () {
    Livewire::test(ToastManager::class)
