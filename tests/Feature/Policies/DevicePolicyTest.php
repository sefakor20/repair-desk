...
test('any authenticated user can view any device', function (): void {
...
test('any authenticated user can view a device', function (): void {
    $user = User::factory()->create(['role' => UserRole::Technician]);
    $device = Device::factory()->create();
...
test('any authenticated user can create a device', function (): void {
    $user = User::factory()->create(['role' => UserRole::Technician]);

    expect($user->can('create', Device::class))->toBeTrue();
});

test('any authenticated user can update a device', function (): void {
    $user = User::factory()->create(['role' => UserRole::Technician]);
    $device = Device::factory()->create();
...
test('admin can delete a device', function (): void {
...
test('manager can delete a device', function (): void {
...
test('technician cannot delete a device', function (): void {
    $user = User::factory()->create(['role' => UserRole::Technician]);
    $device = Device::factory()->create();
...
test('admin can restore a device', function (): void {
    $user = User::factory()->create(['role' => UserRole::Admin]);
    $device = Device::factory()->create();
...
test('manager can restore a device', function (): void {
    $user = User::factory()->create(['role' => UserRole::Manager]);
    $device = Device::factory()->create();
...
test('technician cannot restore a device', function (): void {
    $user = User::factory()->create(['role' => UserRole::Technician]);
    $device = Device::factory()->create();
...
test('only admin can force delete a device', function (): void {
