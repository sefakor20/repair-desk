<div x-data="{
    ...
    <div x-show="isOpen" x-on:keydown.escape.window="$wire.close()" x-on:keydown.down.prevent="$wire.selectNext()"
        x-on:keydown.up.prevent="$wire.selectPrevious()" x-on:keydown.enter.prevent="$wire.executeSelected()" x-cloak
