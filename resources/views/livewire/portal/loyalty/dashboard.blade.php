    ...
    <div class="space-y-6">
        ...
        <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-700 dark:bg-zinc-800">
                ...
                <flux:heading size="2xl" class="mb-1">{{ number_format($account->total_points) }}</flux:heading>
            ...
            <div class="rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-700 dark:bg-zinc-800">
                <div class="mb-2 flex items-center justify-between">
                    <flux:text class="text-sm font-medium text-zinc-500 dark:text-zinc-400">Lifetime Points</flux:text>
        ...
        <div class="grid gap-6 lg:grid-cols-2">
            ...
            <div class="rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-700 dark:bg-zinc-800">
                <div class="mb-4 flex items-center justify-between">
                    ...
                    <flux:button variant="ghost" size="sm"
                        href="{{ route('portal.loyalty.rewards', ['customer' => $customer->id]) }}">
                        View All →
                    </flux:button>
                </div>
            ...
            <div class="rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-700 dark:bg-zinc-800">
                <div class="mb-4 flex items-center justify-between">
                    ...
                    <flux:button variant="ghost" size="sm"
                        href="{{ route('portal.loyalty.history', ['customer' => $customer->id]) }}">
                        View All →
                    </flux:button>
                </div>
            ...
            <div class="grid gap-4 sm:grid-cols-3">
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <flux:text class="text-sm text-zinc-500">Higher tiers earn more points per purchase</flux:text>
                    </div>
                </div>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <flux:text class="text-sm text-zinc-500">Use your points for discounts and vouchers</flux:text>
                    </div>
                </div>
            </div>
        </div>
