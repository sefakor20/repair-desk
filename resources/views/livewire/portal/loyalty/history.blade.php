                    ...
                    <table class="w-full">
                        <thead class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium uppercase text-zinc-500">Description
                                </th>
                                <th class="px-6 py-3 text-right text-xs font-medium uppercase text-zinc-500">Points</th>
                                <th class="px-6 py-3 text-right text-xs font-medium uppercase text-zinc-500">Balance
                                </th>
                            </tr>
                        </thead>
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="px-6 py-16 text-center">
                                        <flux:icon.clock
                                            class="mx-auto mb-3 size-12 text-zinc-300 dark:text-zinc-600" />
                                        <flux:heading size="sm" class="mb-2">No transactions found</flux:heading>
                                        <flux:text class="text-zinc-500">Your points activity will appear here
                                        </flux:text>
                                    </td>
                                </tr>
                            @endforelse
