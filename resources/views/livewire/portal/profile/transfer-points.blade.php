<div>
    <x-layouts.portal-content :customer="$customer" title="Transfer Points">
        <div class="space-y-6">
            <!-- Balance Card -->
            <div
                    ...
                    <div class="flex flex-col md:flex-row items-center justify-between gap-6">
                        <div class="text-white">
                            ...
                            <p class="mt-2 text-4xl font-bold">
                                {{ number_format($customer->loyaltyAccount->total_points) }}</p>
            ...
            <flux:callout variant="info">
                <div class="flex items-start gap-3">
                    <svg class="size-5 text-blue-600 dark:text-blue-400 flex-shrink-0 mt-0.5" fill="none"
                    ...
                    <div class="text-sm">
                        ...
                        <p class="mt-1 text-zinc-600 dark:text-zinc-400">
                            You can gift your points to other customers. The minimum transfer is 50 points. Transfers
                            are
            ...
            <div
                                        ...
                                        <div class="flex-shrink-0">
                                            ...
                                            @else
                                                <div
                                                    ...
                                                    <svg class="size-5 text-green-600 dark:text-green-400"
                ...
                @else
                    <div class="px-6 py-12 text-center">
                        <svg class="mx-auto size-12 text-zinc-400" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" />
                        </svg>
                        <h3 class="mt-2 text-sm font-semibold text-zinc-900 dark:text-white">No transfers yet</h3>
                        <p class="mt-1 text-sm text-zinc-600 dark:text-zinc-400">Start gifting points to friends and
                            family!</p>
                        <div class="mt-6">
            ...
            <flux:modal :open="$showTransferModal" wire:model="showTransferModal">
                <form wire:submit="transfer" class="space-y-6">
                    ...
                    <flux:field>
                        ...
                        <flux:input type="email" wire:model="recipient_email" placeholder="recipient@example.com"
                            required />
