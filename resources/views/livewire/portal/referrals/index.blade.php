<div>
    <x-layouts.portal-content :customer="$customer" title="Referrals">
        <div class="space-y-6">
            <!-- Stats Cards -->
                    ...
                    <div class="flex flex-col md:flex-row items-center justify-between gap-6">
                        ...
                        <div class="flex items-center gap-3">
                            <div class="bg-white/20 backdrop-blur-sm rounded-lg px-6 py-3 border border-white/30">
                                <code
                                    class="text-2xl font-mono font-bold text-white tracking-wider">{{ $referralCode }}</code>
                            </div>

                            <flux:button variant="ghost"
                                class="!bg-white/20 hover:!bg-white/30 !text-white border border-white/30"
                                wire:click="copyCode" x-on:click="navigator.clipboard.writeText('{{ $referralCode }}')">
            ...
            <div
                ...
                @else
                    <div class="px-6 py-12 text-center">
                        ...
                        <p class="mt-1 text-sm text-zinc-600 dark:text-zinc-400">Start sharing your referral code to
                            earn
                            rewards!</p>
                        <div class="mt-6">
            ...
            <flux:modal :open="$showInviteModal" wire:model="showInviteModal">
                <form wire:submit="sendInvite" class="space-y-6">
                    ...
                    <flux:field>
                        ...
                        <flux:input type="email" wire:model="friend_email" placeholder="friend@example.com"
                            required />
