    ...
    <div class="mb-6 flex items-center justify-between">
        ...
        <div>
            <div class="flex gap-2">
                ...
                <flux:button variant="ghost" wire:click="toggleAnalytics" icon="chart-bar">
    ...
    @if ($showAnalytics)
        <div class="mb-6 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <div class="rounded-lg border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900">
                <div class="text-sm font-medium text-zinc-600 dark:text-zinc-400">Total Campaigns</div>
                <div class="text-2xl font-bold text-zinc-900 dark:text-zinc-100">
                    {{ number_format($this->analytics['total_campaigns']) }}
                </div>
                <div class="text-xs text-zinc-500">{{ number_format($this->analytics['recent_campaigns']) }} this month
                </div>
            </div>

            <div class="rounded-lg border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900">
                <div class="text-sm font-medium text-zinc-600 dark:text-zinc-400">Messages Sent</div>
                <div class="text-2xl font-bold text-emerald-600 dark:text-emerald-400">
                    {{ number_format($this->analytics['total_sent']) }}
                </div>
                <div class="text-xs text-zinc-500">{{ number_format($this->analytics['recent_sent']) }} this month</div>
            </div>

            <div class="rounded-lg border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900">
                <div class="text-sm font-medium text-zinc-600 dark:text-zinc-400">Delivery Rate</div>
                <div class="text-2xl font-bold text-blue-600 dark:text-blue-400">
                    {{ $this->analytics['avg_delivery_rate'] }}%
                </div>
                <div class="text-xs text-zinc-500">{{ number_format($this->analytics['total_failed']) }} failed</div>
            </div>

            <div class="rounded-lg border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900">
                <div class="text-sm font-medium text-zinc-600 dark:text-zinc-400">Total Cost</div>
                <div class="text-2xl font-bold text-purple-600 dark:text-purple-400">
                    {{ format_currency($this->analytics['total_cost']) }}
                </div>
                <div class="text-xs text-zinc-500">{{ number_format($this->analytics['active_campaigns']) }} active
                </div>
            </div>
        </div>
    @endif
