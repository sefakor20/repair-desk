<div x-data="{ isOpen: @entangle('isOpen') }">
    <div x-show="isOpen" x-on:keydown.escape.window="$wire.close()" x-cloak
        ...
        <div x-on:click.outside="$wire.close()"
            ...
            <div class="max-h-[calc(100vh-16rem)] overflow-y-auto p-6">
                ...
                <!-- Pro Tips -->
                <div
                    class="mt-8 rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-900 dark:bg-blue-900/20">
            ...
            <div class="border-t border-zinc-200 bg-zinc-50 px-6 py-4 dark:border-zinc-700 dark:bg-zinc-900">
                <div class="flex items-center justify-between">
                    <p class="text-sm text-zinc-500 dark:text-zinc-400">
                        Press <kbd
                            class="rounded bg-white px-2 py-1 text-xs font-semibold shadow-sm dark:bg-zinc-800">?</kbd>
                        to
