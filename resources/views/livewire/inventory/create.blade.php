<div>
    ...
    <div class="mb-6 flex items-center gap-2 text-sm text-zinc-600 dark:text-zinc-400">
        ...
        <span>/</span>
        <span class="text-zinc-900 dark:text-white">{{ __('Create') }}</span>
    </div>

    {{-- Header --}}
    <div class="mb-6">
        <flux:heading size="xl" class="mb-2">{{ __('Add Inventory Item') }}</flux:heading>
        <flux:text>{{ __('Add a new part or product to your inventory') }}</flux:text>
    </div>
        ...
        <div class="space-y-6">
            ...
            <div class="rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-700 dark:bg-zinc-800">
                ...
                <div class="grid gap-6 md:grid-cols-2">
                    ...
                    <div>
                        <flux:field>
                            <flux:label for="quantity">{{ __('Initial Quantity') }} <span class="text-red-500">*</span>
                            </flux:label>
                            <flux:input wire:model="quantity" id="quantity" type="number" min="0"
                                placeholder="0" :invalid="$errors->has('quantity')" />
                            <flux:description>{{ __('Starting stock level') }}</flux:description>
