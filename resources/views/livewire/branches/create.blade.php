<div class="max-w-2xl space-y-6">
    <div>
        <h1 class="text-2xl font-semibold text-zinc-900 dark:text-white">Create Branch</h1>
        <p class="mt-1 text-sm text-zinc-600 dark:text-zinc-400">Add a new business location or branch.</p>
    </div>
